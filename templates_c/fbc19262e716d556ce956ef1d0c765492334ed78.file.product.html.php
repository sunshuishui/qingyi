<?php /* Smarty version Smarty-3.1.18, created on 2015-05-07 11:33:34
         compiled from ".\templates\product.html" */ ?>
<?php /*%%SmartyHeaderCode:27304554a0a38838b32-58853945%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '27304554a0a38838b32-58853945',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_554a0a389bee55_25978668',
  'variables' => 
  array (
    'type' => 0,
    'arrtext' => 0,
...
<?php if ($_valid && !is_callable('content_554a0a389bee55_25978668')) {function content_554a0a389bee55_25978668($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'E:\\wamp\\www\\qingyi\\Smarty\\plugins\\modifier.truncate.php';
?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312" />
<title>擎翌智能产品介绍</title>
            ...
            <div class="nyMainRight">
                <h1 class="nyMainRightH1">
                    <span>
                        ...
                        首页 &gt; 产品介绍 &gt;<?php echo $_smarty_tpl->tpl_vars['arrtext']->value[$_smarty_tpl->tpl_vars['type']->value];?>
...
?>
                                    <li><span class="nyMainMidCont2"><a href="product_infor.php?id=<?php echo $_smarty_tpl->tpl_vars['article']->value[$_smarty_tpl->getVariable('smarty')->value['section']['sn']['index']]['id'];?>
...
">
                                        ...
                                        <div class="nyCaseC">
                                            <div class="nyCasePic">
                                                <a href="product_infor.php?id=<?php echo $_smarty_tpl->tpl_vars['article']->value[$_smarty_tpl->getVariable('smarty')->value['section']['sn']['index']]['id'];?>
&type=<?php echo $_smarty_tpl->tpl_vars['article']->value[$_smarty_tpl->getVariable('smarty')->value['section']['sn']['index']]['type'];?>
">
...
" alt="" width="120px" height="75px" /></a></div>
                                            <div class="nyCaseWord">
                                                <?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['article']->value[$_smarty_tpl->getVariable('smarty')->value['section']['sn']['index']]['smallcontent'],'150');?>
                        ...
                        <div>
							...
							<a style="color:black;" href="" class="pager">首页</a>&nbsp;
							<?php if ($_smarty_tpl->tpl_vars['page']->value>1) {?>
							<a style="color:black;" href="" class="pager">上页</a>
							<?php } else { ?>
							上页
							<?php }?>
							<?php if (isset($_smarty_tpl->tpl_vars['smarty']->value['section']['sn'])) unset($_smarty_tpl->tpl_vars['smarty']->value['section']['sn']);
...
?>
								...
								<?php } else { ?>
								&nbsp;<a style="color:black;" href="" class="pager"><?php echo $_smarty_tpl->getVariable('smarty')->value['section']['sn']['index']+1;?>
</a>
								<?php }?>
							<?php endfor; endif; ?>
							&nbsp;<?php if ($_smarty_tpl->tpl_vars['page']->value<$_smarty_tpl->tpl_vars['countpage']->value) {?><a style="color:black;" href="" class="pager">下页</a><?php } else { ?>下页<?php }?>
							&nbsp;<a style="color:black;" href="" class="pager">尾页</a>&nbsp;</div></div>
                            <div class="clear">
                            </div>
                        </div>
